          ...
          {selectedAgent === "twitter" ? (
            <div className="flex flex-col gap-6">
                  ...
                  <button
                    ...
                    onClick={() => {
                      ...
                      downloadMarkdown(
                        ...
                        buildTwitterFileName(parseTwitterProfileUrls(twitterProfileUrlsInput)),
                      );
                    }}
              ...
              <section className="rounded-2xl border border-slate-800 bg-slate-900/70 p-6">
                ...
                {twitterRunSessionId ? (
                  <p className="mb-3 text-xs text-slate-400">Session ID: {twitterRunSessionId}</p>
                ) : null}

                {twitterLiveUrl ? (
                  <iframe
                    title="Twitter Browser Live URL"
                    src={twitterLiveUrl}
                    className="h-[640px] w-full rounded-lg border border-slate-800 bg-slate-950"
                    allow="clipboard-read; clipboard-write"
                  />
